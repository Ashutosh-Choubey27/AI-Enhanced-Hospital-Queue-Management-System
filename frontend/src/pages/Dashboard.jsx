...
import { StaggeredReveal, StaggerItem } from "../components/loading/StaggeredReveal";
  ...
  return (
    ...
    >
      <AnimatePresence mode="wait">
        {loading ? (
          <DashboardSkeleton key="dashboard-loading" />
        ) : (
          <StaggeredReveal key="dashboard-content">
            <StaggerItem>
            ...
            <div className="card-header">
              <div>
                ...
                <div className="mt-1 text-xs text-slate-500 dark:text-slate-400">
                  Models combine historical OPD patterns with live queue signals for accurate short-term forecasts.
                </div>
              </div>
            </div>
            <div className="card-body space-y-3 text-sm text-slate-700 dark:text-slate-200">
              <p>
                Crowd and wait-time cards refresh automatically. Book, check in, and track your token—queue state updates in
                real time across the hospital network.
              </p>
            </div>
          </div>
        </div>
