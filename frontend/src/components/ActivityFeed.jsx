    ...
    <div className="card">
      ...
      <div className="card-body space-y-3">
        {content.length ? (
          ...
          <div className="rounded-2xl border border-dashed border-slate-200/80 bg-slate-50/50 px-4 py-8 text-center dark:border-slate-800 dark:bg-slate-900/30">
            <div className="text-sm font-semibold text-slate-700 dark:text-slate-200">All quiet for now</div>
            <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
              Check-ins and token calls will appear here as they happen across OPD floors.
            </p>
          </div>
        )}
      </div>
