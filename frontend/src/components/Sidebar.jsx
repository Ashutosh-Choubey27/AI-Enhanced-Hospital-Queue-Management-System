    ...
    <aside className="hidden lg:flex lg:w-72 lg:flex-col lg:gap-6 lg:border-r lg:border-slate-200 lg:bg-white dark:lg:border-slate-800 dark:lg:bg-slate-950">
      ...
      <div className="mt-auto px-6 pb-6">
        <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 dark:border-slate-800 dark:bg-slate-900">
          <div className="text-xs font-semibold text-slate-600 dark:text-slate-400">Care tip</div>
          <div className="mt-1 text-xs text-slate-600 dark:text-slate-400">
            Use <span className="font-semibold text-slate-800 dark:text-slate-200">Book Appointment</span> for AI-ranked doctor recommendations.
          </div>
        </div>
      </div>
    </aside>
